...
public class CommandCenter {
	...
	public static CopyOnWriteArrayList<Movable> getMovFloaters() {
     ...
     public static void decEscape()
     {
         nEscape--;
     }

    public static void incEscape()
    {
        nEscape++;
    }

     public static int getnEscape()
     {
         return nEscape;
     }

    public static void setnEscape(int n)
    {
        nEscape = n;
    }
